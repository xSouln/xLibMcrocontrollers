...
//==============================================================================
typedef struct{
  volatile UsartCR1_T CR1;/*!< USART Control register 1,                 Address offset: 0x00 */
  volatile UsartCR2_T CR2;/*!< USART Control register 2,                 Address offset: 0x04 */
  volatile UsartCR3_T CR3;/*!< USART Control register 3,                 Address offset: 0x08 */
  volatile UsartBRR_T BRR;/*!< USART Baud rate register,                 Address offset: 0x0C */

  volatile UsartGTPR_T GTPR;/*!< USART Guard time and prescaler register,  Address offset: 0x10 */
  volatile UsartRTOR_T RTOR;/*!< USART Receiver Time Out register,         Address offset: 0x14 */
  volatile UsartRQR_T RQR;/*!< USART Request register,                   Address offset: 0x18 */
  volatile UsartISR_T ISR;/*!< USART Interrupt and status register,      Address offset: 0x1C */

  volatile UsartICR_T ICR;/*!< USART Interrupt flag Clear register,      Address offset: 0x20 */
  volatile UsartRDR_T RDR;/*!< USART Receive Data register,              Address offset: 0x24 */
  volatile UsartTDR_T TDR;/*!< USART Transmit Data register,             Address offset: 0x28 */
  volatile UsartPRESC_T PRESC;/*!< USART clock Prescaler register,           Address offset: 0x2C */
}UsartRegT; //USART_TypeDef
//==============================================================================
